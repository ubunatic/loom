...
// (TreemapThemeNumbered, seven-eighths-block boundary glyphs plus a corner
// number on every box) -- see issue 040. Theme 2 requires --ansi, since it
// has no color to render its edge glyphs with otherwise.
