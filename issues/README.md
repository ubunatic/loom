...
| 024 | [024-port-harnez-rograph-primitives-with-provenance.md](024-port-harnez-rograph-primitives-with-provenance.md) | Port Harnez rograph primitives with provenance | Closed — dependency-free graph package ported with provenance, immutable constants, and exact-width padding |
